...
knitr::kable(cheat_cheet_figura_1a)
```
...
knitr::kable(cheat_cheet_figura_1b)
```
...
knitr::kable(cheat_cheet_figura_2a) %>% 
  add_footnote(lang_label("population_pfa_filter"), notation = "none")
```
...
knitr::kable(cheat_cheet_figura_2a) %>% 
  add_footnote(lang_label("population_pfa_no_filter"), notation = "none")
```
...
knitr::kable(cheat_cheet_figura_2b) %>% 
  add_footnote(lang_label("population_pfa_filter"), notation = "none")
```
...
knitr::kable(cheat_cheet_figura_2c) %>% 
  add_footnote(lang_label("population_pfa_filter"), notation = "none")
```
...
knitr::kable(cheat_cheet_figura_3a) %>% 
  add_footnote(lang_label("population_pfa_filter"), notation = "none")
```
...
knitr::kable(cheat_cheet_figura_3b) %>% 
  add_footnote(lang_label("population_pfa_filter"), notation = "none")
```
...
knitr::kable(cheat_cheet_figura_3c) %>% 
  add_footnote(lang_label("population_pfa_filter"), notation = "none")
```
