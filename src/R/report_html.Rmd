...
knitr::kable(table_1a, align = "lr", booktabs = TRUE, col.names = NULL) %>% 
  kable_styling()
```

## `r title_name_table` 1b: `r lang_label("table_1b_title")`, `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
colnames(mun_risk_levels_df) <- c(
  ...
  paste0(lang_label("table_number_of")," ",rep_label_admin2_name_plural),
  paste0(lang_label("table_pct_of")," ",rep_label_admin2_name_plural),
  lang_label("table_1a_pob1_html"),
  lang_label("table_1b_pob5_html"),
  lang_label("table_1b_pob15_html")
)

knitr::kable(mun_risk_levels_df,align = "lrrrrrr", booktabs = T) %>% 
  add_footnote(lang_label("table_1b_footnote"), notation = "symbol") %>% 
  kable_styling()
```


## `r title_name_figure` 1a: `r lang_label("figure_1a_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_1a = ind_rangos_table(LANG_TLS,CUT_OFFS,"total_score", TRUE)
cheat_cheet_figura_1a
```


## `r title_name_figure` 1b: `r lang_label("figure_1b_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_1b = ind_rangos_table(LANG_TLS,CUT_OFFS,"total_score", TRUE)
cheat_cheet_figura_1b
```


## `r title_name_figure` 1c: `r lang_label("figure_1c_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
## `r title_name_table` 2a: `r lang_label("table_2a_title")`, `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
## `r title_name_figure` 2a: `r lang_label("figure_2a_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_2a = ind_rangos_table(LANG_TLS,CUT_OFFS,"immunity_score", TRUE, lang_label("population_pfa_filter"))
cheat_cheet_figura_2a
```

```{r cheat_sheet_figura_2a_pfa_false, echo=FALSE}
cheat_cheet_figura_2a = ind_rangos_table(LANG_TLS,CUT_OFFS,"immunity_score", FALSE, lang_label("population_pfa_no_filter"))
cheat_cheet_figura_2a
```


## `r title_name_figure` 2b: `r lang_label("figure_2b_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_2b = ind_rangos_table(LANG_TLS,CUT_OFFS,"immunity_score", TRUE, lang_label("population_pfa_filter"))
cheat_cheet_figura_2b
```


## `r title_name_figure` 2c: `r lang_label("figure_2c_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_2c = ind_rangos_table(LANG_TLS,CUT_OFFS,"immunity_score", TRUE, lang_label("population_pfa_filter"))
cheat_cheet_figura_2c
```


```{r cheat_sheet_figura_2c_pfa_false, echo=FALSE}
cheat_cheet_figura_2c = ind_rangos_table(LANG_TLS,CUT_OFFS,"immunity_score", FALSE, lang_label("population_pfa_no_filter"))
cheat_cheet_figura_2c
```
...
## `r title_name_table` 3a: `r lang_label("table_3a_title")`, `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
## `r title_name_figure` 3a: `r lang_label("figure_3a_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_3a = ind_rangos_table(LANG_TLS,CUT_OFFS,"surveillance_score", TRUE, lang_label("population_pfa_filter"))
cheat_cheet_figura_3a
```

```{r cheat_sheet_figura_3a_pfa_false, echo=FALSE}
cheat_cheet_figura_3a = ind_rangos_table(LANG_TLS,CUT_OFFS,"surveillance_score", FALSE, lang_label("population_pfa_no_filter"))
cheat_cheet_figura_3a
```


## `r title_name_figure` 3b: `r lang_label("figure_3b_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_3b = ind_rangos_table(LANG_TLS,CUT_OFFS,"surveillance_score", TRUE, lang_label("population_pfa_filter"))
cheat_cheet_figura_3b
```

## `r title_name_figure` 3c: `r lang_label("figure_3c_title")` `r ref_country_name`, `r YEAR_1`-`r YEAR_5`.
...
cheat_cheet_figura_3c = ind_rangos_table(LANG_TLS,CUT_OFFS,"surveillance_score", TRUE, lang_label("population_pfa_filter"))
cheat_cheet_figura_3c
```

```{r cheat_sheet_figura_3c_pfa_false, echo=FALSE}
cheat_cheet_figura_3c = ind_rangos_table(LANG_TLS,CUT_OFFS,"surveillance_score", FALSE, lang_label("population_pfa_no_filter"))
cheat_cheet_figura_3c
```
...
knitr::kable(quality_df, align = "lr", booktabs = TRUE, col.names = NULL) %>% 
  kable_styling()
```
\newline

# __`r lang_label("title_name_section")` 5: `r lang_label("table_cut_offs_riskcats")`__
```{r cutoffs_image, echo = FALSE}

cutoffs_image <- case_when(
  LANG == "SPA" ~ "cutoffs_SPA.png",
  LANG == "POR" ~ "cutoffs_POR.png",
  LANG == "ENG" ~ "cutoffs_ENG.png",
  LANG == "FRA" ~ "cutoffs_FRA.png"
)

# Path to the image file
image_path <- paste0("../R/cut_offs_excel/", cutoffs_image)
